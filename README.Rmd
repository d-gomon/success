...
The goal of the \pkg{success} package is to allow easy applications of continuous time CUSUM procedures on survival data. Specifically, the Biswas \& Kalbfleisch CUSUM (2008) and the CGR-CUSUM (Gomon et al. 2022).
...
Gomon D., Putter H., Nelissen R.G.H.H., van der Pas S (2022): [CGR-CUSUM: A Continuous time Generalized Rapid Response Cumulative Sum chart](https://doi.org/10.1093/biostatistics/kxac041), *Biostatistics*

Biswas P. and Kalbfleisch J.D. (2008): [A risk-adjusted CUSUM in continuous time based on the Cox model](https://doi.org/10.1002/sim.3216), *Statistics in Medicine*

Spiegelhalter D.J. (2005): [Funnel plots for comparing institutional performance](https://doi.org/10.1002/sim.1970), *Statistics in Medicine*
